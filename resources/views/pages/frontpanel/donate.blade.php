...
include('header.php');
?>
<div style="-webkit-overflow-scrolling:touch;"><iframe src="https://www.ammado.com/guest/76cd73a8-20e0-4f63-aa39-c154eb701217/givingwidget" width="320" height="436" frameborder="0" marginwidth="0" marginheight="0" hspace="0" vspace="0" style="border: 1px solid #dadada;"></iframe></div>

    <h1>PHP Library Create Order Example</h1>
        <form method="post" action="{!!url('/donate')!!}" id="my-payment-form">
           ...
           <div class="form-row">
            ...
            <div class="form-row">
             ...
             <div class="form-row apm apm-url" style="display:none;">
                ...
                <input type="text" id="success-url" name="success-url" placeholder=""/>
            </div>
             ...
             <div class="form-row apm apm-url" style="display:none;">
                ...
                <input type="text" id="cancel-url" name="cancel-url" placeholder=""/>
            </div>
             ...
             <div class="form-row apm apm-url" style="display:none;">
                ...
                <input type="text" id="failure-url" name="failure-url" placeholder=""/>
            </div>
             ...
             <div class="form-row apm apm-url" style="display:none;">
                ...
                <input type="text" id="pending-url" name="pending-url" placeholder=""/>
            </div>
    ...
    <script type="text/javascript">
        ...
        if (!window['Worldpay']) {
            ...
            // Set client key
            Worldpay.setClientKey({!!config('contants.keys.client_key') !!});
            // Get form element
...
<script type="text/javascript">
        ...
        //         'clientKey':'T_C_e6f70106-df30-48de-ae84-441e3df3dab9',
        //         'form':'paymentForm',
